...
| 3 | handoff/validacao-externa-convenio | continuidade fora do app | 1 | saida do app para validacao externa | 1 validacao externa (evidencia, nao template) | 2 validacoes externas (evidencia, nao template) |
| 4 | handoff/retorno-ao-app | retorno ao app Itau | 1 | fim da validacao externa | sem diferenca registrada | sem diferenca registrada |
| 5 | fronteira/retorno-carregando | fronteira de transicao | 1 | retorno ao app | sem diferenca registrada | sem diferenca registrada |
| 6 | fronteira/efetivacao | fronteira de transicao | 1 | continuidade apos carregamento | sem diferenca registrada | sem diferenca registrada |
| 7 | anuencia/tutorial-passo-1 | caminho de ajuda opcional | 2 | \|Saiba o passo a passo\| | sem diferenca registrada | sem diferenca registrada |
| 8 | anuencia/tutorial-passo-2 | caminho de ajuda opcional | 2 | \|Proximo passo\| | sem diferenca registrada | sem diferenca registrada |
| 9 | anuencia/tutorial-passo-3 | caminho de ajuda opcional | 2 | \|Proximo passo\| | sem diferenca registrada | sem diferenca registrada |
| 10 | anuencia/tutorial-passo-4 | caminho de ajuda opcional | 2 | \|Ir para confirmacao externa\| | sem diferenca registrada | sem diferenca registrada |
...
flowchart TD
    ...
    x -->|Cluster 4: 1 validacao externa| r[Retorno ao app]
    x -->|Gov SP: 2 validacoes externas| r
