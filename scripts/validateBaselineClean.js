...
const allowedReferenceDocs = new Set([
  ...
  'docs/contratos/pacote-analista.schema.json',
  'docs/contratos/plano-variaveis-analise.schema.json',
  'docs/contratos/pacote-montagem.schema.json',
  'docs/contratos/veredito-validador.schema.json',
  'docs/contratos/pacote-promocao.schema.json',
  'docs/contratos/escopo-momento.schema.json',
  'docs/contratos/momento.schema.json',
  'docs/contratos/composicao-etapa.schema.json',
