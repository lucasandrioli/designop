...
| L-023 | Saida estrutural grande deve começar resumida e pedir detalhe apenas para o fato em investigacao. Se uma parte nao for lida, ela permanece lacuna, sem extrapolacao por semelhanca. | GENERICO | laboratorio MCP com output truncado | CONSOLIDADO | collectReferenceStructure, consignado-analise |
