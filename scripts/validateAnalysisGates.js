...
const analystPackageCore = read('scripts/validateAnalystPackageCore.js');
...
requireText('scripts/renderAnalystStatus.js', analystRenderer, 'validateAnalystPackage.js');
requireText('scripts/validateAnalystPackageCore.js', analystPackageCore, 'PRONTO_PARA_REVISAO');
requireText('scripts/validateAnalystPackage.js', analystPackageValidator, 'hash divergente');
requireText('docs/contratos/pacote-analista.schema.json', analystPackageSchema, 'PLANO_VARIAVEIS');
requireText('.github/skills/consignado-analise/SKILL.md', analysis, 'createAnalystPackage.js');
requireText('.github/agents/analista.agent.md', analyst, 'pacote-analista.json');
