...
"Você VAI ATUAR como o agente `comparador` deste repositório de DesignOps (crédito consignado, Itaú). Leia primeiro, por inteiro: .github/agents/comparador.agent.md e a skill que ele indica (.github/skills/consignado-comparador/SKILL.md). Siga à risca. Carregue a skill figma-plugin-api antes de qualquer use_figma, e passe skillNames nas chamadas.
