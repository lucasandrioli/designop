...
const allStates = ['PREPARANDO', 'ANALISANDO', 'AGUARDANDO_APROVACAO_CONTRATO', 'MONTANDO', 'VALIDANDO', 'AGUARDANDO_APROVACAO_PROMOCAO', 'AGUARDANDO_DECISAO_DO_DESIGNER', 'BLOQUEADA', 'INTERROMPIDA', 'CONCLUIDA']
const allowed = {
  ANALISTA: { ANALISAR: ['PREPARANDO', 'ANALISANDO'] },
  OPERADOR: { CONSULTAR_BASE: ['ANALISANDO', 'AGUARDANDO_DECISAO_DO_DESIGNER'] },
  MONTADOR: { MONTAR: ['MONTANDO'] },
